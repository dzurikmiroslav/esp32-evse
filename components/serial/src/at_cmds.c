...
static struct cat_variable vars_wifi_config[] = {
    { .type = CAT_VAR_UINT_DEC, .data = &var_u8_1, .data_size = sizeof(var_u8_1), .name = "enabled", .access = CAT_VAR_ACCESS_READ_WRITE, .read = var_wifi_config_enabled_read },
    { .type = CAT_VAR_BUF_STRING, .data = var_str32_1, .data_size = sizeof(var_str32_1), .name = "ssid", .access = CAT_VAR_ACCESS_READ_WRITE, .read = var_wifi_config_ssid_read },
    { .type = CAT_VAR_BUF_STRING, .data = var_str32_2, .data_size = sizeof(var_str32_2), .name = "password", .access = CAT_VAR_ACCESS_WRITE_ONLY }
};
...
static struct cat_variable vars_wifi_connection[] = {
    { .type = CAT_VAR_UINT_DEC, .data = &var_u8_1, .data_size = sizeof(var_u8_1), .name = "connection", .access = CAT_VAR_ACCESS_READ_ONLY, .read = var_wifi_connection_read }
};
...
static struct cat_variable vars_wifi_mode[] = { { .type = CAT_VAR_UINT_DEC,
                                                  .data = &var_u8_1,
...
static struct cat_variable vars_serial_config[] = {
    { .type = CAT_VAR_UINT_DEC, .data = &var_u8_1, .data_size = sizeof(var_u8_1), .name = "mode", .access = CAT_VAR_ACCESS_READ_WRITE, .read_ex = var_serial_config_mode_read },
    ...
    { .type = CAT_VAR_INT_DEC, .data = &var_u8_4, .data_size = sizeof(var_u8_4), .name = "parity", .access = CAT_VAR_ACCESS_READ_WRITE, .read_ex = var_serial_config_parity_read }
};
...
static struct cat_variable vars_charging_current[] = { { .type = CAT_VAR_UINT_DEC,
                                                         .data = &var_u16_1,
...
static struct cat_variable vars_default_charging_current[] = { { .type = CAT_VAR_UINT_DEC,
                                                                 .data = &var_u16_1,
                                                                 .data_size = sizeof(var_u16_1),
                                                                 .name = "current",
                                                                 .access = CAT_VAR_ACCESS_READ_WRITE,
...
static struct cat_variable vars_socket_outlet[] = { { .type = CAT_VAR_UINT_DEC,
                                                      .data = &var_u8_1,
                                                      .data_size = sizeof(var_u8_1),
                                                      .name = "socket_outlet",
                                                      .access = CAT_VAR_ACCESS_READ_WRITE,
...
static struct cat_variable vars_require_auth[] = { { .type = CAT_VAR_UINT_DEC,
                                                     .data = &var_u8_1,
                                                     .data_size = sizeof(var_u8_1),
                                                     .name = "require_auth",
                                                     .access = CAT_VAR_ACCESS_READ_WRITE,
...
static struct cat_variable vars_energy_meter_mode[] = { { .type = CAT_VAR_UINT_DEC,
                                                          .data = &var_u8_1,
                                                          .data_size = sizeof(var_u8_1),
                                                          .name = "mode",
                                                          .access = CAT_VAR_ACCESS_READ_WRITE,
...
static struct cat_variable vars_energy_meter_ac_voltage[] = { { .type = CAT_VAR_UINT_DEC,
                                                                .data = &var_u16_1,
                                                                .data_size = sizeof(var_u16_1),
                                                                .name = "voltage",
                                                                .access = CAT_VAR_ACCESS_READ_WRITE,
...
static struct cat_variable vars_enabled[] = { { .type = CAT_VAR_UINT_DEC,
                                                .data = &var_u8_1,
                                                .data_size = sizeof(var_u8_1),
                                                .name = "enabled",
                                                .access = CAT_VAR_ACCESS_READ_WRITE,
...
static struct cat_command cmds[] = {
    { .name = "+CMD", .run = cmd_cmd_run },
    { .name = "E0", .run = cmd_echo_run },
    { .name = "E1", .run = cmd_echo_run },
    { .name = "+RST", .run = cmd_rst_run },
    { .name = "+WIFICFG", .write = cmd_wifi_config_write, .var = vars_wifi_config, .var_num = sizeof(vars_wifi_config) / sizeof(vars_wifi_config[0]) },
    { .name = "+WIFICON", .var = vars_wifi_connection, .var_num = sizeof(vars_wifi_connection) / sizeof(vars_wifi_connection[0]) },
    { .name = "+WIFIMODE", .var = vars_wifi_mode, .var_num = sizeof(vars_wifi_mode) / sizeof(vars_wifi_mode[0]), .need_all_vars = true },
    { .name = "+SRLCFG1",
    ...
    { .name = "+SRLCFG3",
      ...
      .need_all_vars = true },
#endif
    { .name = "+CHCUR", .var = vars_charging_current, .var_num = sizeof(vars_charging_current) / sizeof(vars_charging_current[0]), .need_all_vars = true },
    { .name = "+DCHCUR", .var = vars_default_charging_current, .var_num = sizeof(vars_default_charging_current) / sizeof(vars_default_charging_current[0]), .need_all_vars = true },
    { .name = "+SCOU", .var = vars_socket_outlet, .var_num = sizeof(vars_socket_outlet) / sizeof(vars_socket_outlet[0]), .need_all_vars = true },
    { .name = "+RQAUTH", .var = vars_require_auth, .var_num = sizeof(vars_require_auth) / sizeof(vars_require_auth[0]), .need_all_vars = true },
    { .name = "+EMMODE", .var = vars_energy_meter_mode, .var_num = sizeof(vars_energy_meter_mode) / sizeof(vars_energy_meter_mode[0]), .need_all_vars = true },
    { .name = "+EMACVLT", .var = vars_energy_meter_ac_voltage, .var_num = sizeof(vars_energy_meter_ac_voltage) / sizeof(vars_energy_meter_ac_voltage[0]), .need_all_vars = true },
    { .name = "+AUTH", .run = cmd_authorize_run },
    { .name = "+EN", .var = vars_enabled, .var_num = sizeof(vars_enabled) / sizeof(vars_enabled[0]), .need_all_vars = true },
};
