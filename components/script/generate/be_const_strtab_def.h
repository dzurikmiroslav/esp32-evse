...
be_define_const_str(_X21_X3D, "!=", 2428715011u, 0, 2, &be_const_str_list);
be_define_const_str(_X28_X29, "()", 685372826u, 0, 2, &be_const_str_end);
be_define_const_str(_X2B, "+", 772578730u, 0, 1, &be_const_str_ceil);
be_define_const_str(_X2E_X2E, "..", 2748622605u, 0, 2, &be_const_str_value_error);
be_define_const_str(_X2Elen, ".len", 850842136u, 0, 4, &be_const_str_ismethod);
be_define_const_str(_X2Ep, ".p", 1171526419u, 0, 2, NULL);
be_define_const_str(_X2Esize, ".size", 1965188224u, 0, 5, &be_const_str_def);
be_define_const_str(_X3D_X3D, "==", 2431966415u, 0, 2, &be_const_str_STATE_D2);
be_define_const_str(ENERGY_METER_CUR, "ENERGY_METER_CUR", 1351509274u, 0, 16, NULL);
be_define_const_str(ENERGY_METER_CUR_VLT, "ENERGY_METER_CUR_VLT", 1634552099u, 0, 20, &be_const_str_char);
be_define_const_str(ENERGY_METER_NONE, "ENERGY_METER_NONE", 799556618u, 0, 17, &be_const_str__buffer);
be_define_const_str(Evse, "Evse", 1255518258u, 0, 4, &be_const_str_asstring);
be_define_const_str(SERIAL_NONE, "SERIAL_NONE", 1267285320u, 0, 11, &be_const_str___lower__);
be_define_const_str(SERIAL_RS485, "SERIAL_RS485", 1431239208u, 0, 12, &be_const_str_STATE_D1);
be_define_const_str(SERIAL_UART, "SERIAL_UART", 3498043946u, 0, 11, &be_const_str_fromstring);
be_define_const_str(STATE_A, "STATE_A", 758070558u, 0, 7, &be_const_str_allocated);
be_define_const_str(STATE_B1, "STATE_B1", 1213924814u, 0, 8, &be_const_str_asin);
be_define_const_str(STATE_B2, "STATE_B2", 1197147195u, 0, 8, &be_const_str_getbits);
be_define_const_str(STATE_C1, "STATE_C1", 3294099307u, 0, 8, NULL);
be_define_const_str(STATE_C2, "STATE_C2", 3310876926u, 0, 8, &be_const_str_find);
be_define_const_str(STATE_D1, "STATE_D1", 3429453092u, 0, 8, &be_const_str_cosh);
be_define_const_str(STATE_D2, "STATE_D2", 3479785949u, 0, 8, NULL);
be_define_const_str(STATE_E, "STATE_E", 825181034u, 0, 7, &be_const_str_item);
be_define_const_str(STATE_F, "STATE_F", 808403415u, 0, 7, &be_const_str_return);
...
be_define_const_str(_change_buffer, "_change_buffer", 2101848693u, 0, 14, &be_const_str_tolower);
be_define_const_str(_ctx, "_ctx", 3449684691u, 0, 4, &be_const_str_acos);
be_define_const_str(_process, "_process", 1973958659u, 0, 8, NULL);
be_define_const_str(abs, "abs", 709362235u, 0, 3, &be_const_str_static);
be_define_const_str(acos, "acos", 1006755615u, 0, 4, &be_const_str_fromptr);
...
be_define_const_str(allocated, "allocated", 429986098u, 0, 9, &be_const_str_charging_current);
be_define_const_str(analog_read, "analog_read", 3234091506u, 0, 11, &be_const_str_fromhex);
be_define_const_str(as, "as", 1579491469u, 67, 2, &be_const_str_assert);
...
be_define_const_str(atan2, "atan2", 3173440503u, 0, 5, &be_const_str_log);
be_define_const_str(available, "available", 1727918744u, 0, 9, &be_const_str_consumption);
be_define_const_str(bool, "bool", 3365180733u, 0, 4, &be_const_str_class);
be_define_const_str(break, "break", 3378807160u, 58, 5, NULL);
be_define_const_str(byte, "byte", 1683620383u, 0, 4, &be_const_str_pow);
be_define_const_str(bytes, "bytes", 1706151940u, 0, 5, &be_const_str_current);
be_define_const_str(call, "call", 3018949801u, 0, 4, &be_const_str_split);
be_define_const_str(ceil, "ceil", 1659167240u, 0, 4, &be_const_str_else);
be_define_const_str(char, "char", 2823553821u, 0, 4, &be_const_str_replace);
be_define_const_str(charging_current, "charging_current", 2980711800u, 0, 16, &be_const_str_classof);
be_define_const_str(charging_time, "charging_time", 2172372278u, 0, 13, &be_const_str_do);
be_define_const_str(class, "class", 2872970239u, 57, 5, &be_const_str_floor);
be_define_const_str(classname, "classname", 1998589948u, 0, 9, &be_const_str_nan);
...
be_define_const_str(collect, "collect", 2399039025u, 0, 7, &be_const_str_set_available);
...
be_define_const_str(consumption, "consumption", 722593332u, 0, 11, NULL);
be_define_const_str(contains, "contains", 1825239352u, 0, 8, &be_const_str_enabled);
...
be_define_const_str(current, "current", 3647323098u, 0, 7, NULL);
be_define_const_str(def, "def", 3310976652u, 55, 3, NULL);
be_define_const_str(deg, "deg", 3327754271u, 0, 3, &be_const_str_open);
be_define_const_str(deinit, "deinit", 2345559592u, 0, 6, &be_const_str_pi);
be_define_const_str(delay, "delay", 1322381784u, 0, 5, &be_const_str_hex);
be_define_const_str(do, "do", 1646057492u, 65, 2, &be_const_str_number);
be_define_const_str(dump, "dump", 3663001223u, 0, 4, NULL);
be_define_const_str(elif, "elif", 3232090307u, 51, 4, &be_const_str_get);
be_define_const_str(else, "else", 3183434736u, 52, 4, NULL);
be_define_const_str(enabled, "enabled", 49525662u, 0, 7, &be_const_str_ismapped);
be_define_const_str(end, "end", 1787721130u, 56, 3, &be_const_str_false);
be_define_const_str(escape, "escape", 2652972038u, 0, 6, &be_const_str_isnan);
be_define_const_str(except, "except", 950914032u, 69, 6, &be_const_str_imax);
be_define_const_str(exp, "exp", 1923516200u, 0, 3, &be_const_str_for);
be_define_const_str(false, "false", 184981848u, 62, 5, &be_const_str_insert);
be_define_const_str(find, "find", 3186656602u, 0, 4, &be_const_str_toptr);
...
be_define_const_str(fromhex, "fromhex", 1847150394u, 0, 7, &be_const_str_members);
be_define_const_str(fromptr, "fromptr", 666189689u, 0, 7, &be_const_str_push);
be_define_const_str(fromstring, "fromstring", 610302344u, 0, 10, &be_const_str_geti);
...
be_define_const_str(if, "if", 959999494u, 50, 2, &be_const_str_tob64);
...
be_define_const_str(input, "input", 4191711099u, 0, 5, &be_const_str_solidified);
...
be_define_const_str(ismethod, "ismethod", 3513438880u, 0, 8, &be_const_str_rad);
be_define_const_str(isnan, "isnan", 2981347434u, 0, 5, &be_const_str_size);
be_define_const_str(issubclass, "issubclass", 4078395519u, 0, 10, &be_const_str_set_charging_current);
be_define_const_str(item, "item", 2671260646u, 0, 4, NULL);
be_define_const_str(iter, "iter", 3124256359u, 0, 4, &be_const_str_keys);
be_define_const_str(keys, "keys", 4182378701u, 0, 4, &be_const_str_real);
be_define_const_str(length_X20in_X20bits_X20must_X20be_X20between_X200_X20and_X2032, "length in bits must be between 0 and 32", 2584509128u, 0, 39, &be_const_str_time);
...
be_define_const_str(lower, "lower", 3038577850u, 0, 5, &be_const_str_nil);
...
be_define_const_str(nil, "nil", 228849900u, 63, 3, &be_const_str_path);
be_define_const_str(number, "number", 467038368u, 0, 6, &be_const_str_print);
be_define_const_str(open, "open", 3546203337u, 0, 4, &be_const_str_tohex);
be_define_const_str(path, "path", 2223459638u, 0, 4, &be_const_str_tanh);
be_define_const_str(pi, "pi", 1213090802u, 0, 2, &be_const_str_power);
be_define_const_str(pop, "pop", 1362321360u, 0, 3, &be_const_str_rand);
be_define_const_str(pow, "pow", 1479764693u, 0, 3, NULL);
be_define_const_str(power, "power", 4115604294u, 0, 5, &be_const_str_state);
...
be_define_const_str(remove_driver, "remove_driver", 1030243768u, 0, 13, &be_const_str_while);
be_define_const_str(replace, "replace", 2704835779u, 0, 7, NULL);
be_define_const_str(resize, "resize", 3514612129u, 0, 6, NULL);
be_define_const_str(return, "return", 2246981567u, 60, 6, &be_const_str_reverse);
be_define_const_str(reverse, "reverse", 558918661u, 0, 7, NULL);
be_define_const_str(session_time, "session_time", 3430506065u, 0, 12, NULL);
be_define_const_str(set, "set", 3324446467u, 0, 3, &be_const_str_set_enabled);
be_define_const_str(set_available, "set_available", 2820840055u, 0, 13, &be_const_str_setbits);
be_define_const_str(set_charging_current, "set_charging_current", 1932343753u, 0, 20, &be_const_str_sinh);
be_define_const_str(set_enabled, "set_enabled", 3566858229u, 0, 11, NULL);
...
be_define_const_str(seti, "seti", 1500556254u, 0, 4, &be_const_str_setitem);
...
be_define_const_str(split, "split", 2276994531u, 0, 5, &be_const_str_voltage);
...
be_define_const_str(static, "static", 3532702267u, 71, 6, &be_const_str_true);
...
be_define_const_str(voltage, "voltage", 3784531813u, 0, 7, NULL);
...
static const bstring* const m_string_table[] = {
    ...
    (const bstring *)&be_const_str_SERIAL_NONE,
    (const bstring *)&be_const_str_STATE_B2,
    ...
    (const bstring *)&be_const_str_STATE_B1,
    (const bstring *)&be_const_str_deg,
    (const bstring *)&be_const_str_log10,
    (const bstring *)&be_const_str_ENERGY_METER_CUR_VLT,
    (const bstring *)&be_const_str__X28_X29,
    NULL,
    NULL,
    (const bstring *)&be_const_str_STATE_F,
    NULL,
    NULL,
    (const bstring *)&be_const_str_Evse,
    ...
    (const bstring *)&be_const_str_STATE_E,
    ...
    (const bstring *)&be_const_str_ENERGY_METER_NONE,
    (const bstring *)&be_const_str_atan,
    (const bstring *)&be_const_str_contains,
    (const bstring *)&be_const_str__ctx,
    ...
    (const bstring *)&be_const_str__process,
    ...
    (const bstring *)&be_const_str_SERIAL_RS485,
