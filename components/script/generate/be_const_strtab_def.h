...
be_define_const_str(_X2Elen, ".len", 850842136u, 0, 4, &be_const_str_STATE_F);
be_define_const_str(_X2Ep, ".p", 1171526419u, 0, 2, &be_const_str_find);
be_define_const_str(_X2Esize, ".size", 1965188224u, 0, 5, NULL);
be_define_const_str(_X3D_X3D, "==", 2431966415u, 0, 2, &be_const_str_SERIAL_RS485);
be_define_const_str(ENERGY_METER_CUR, "ENERGY_METER_CUR", 1351509274u, 0, 16, &be_const_str_SERIAL_NONE);
be_define_const_str(ENERGY_METER_CUR_VLT, "ENERGY_METER_CUR_VLT", 1634552099u, 0, 20, &be_const_str_as);
be_define_const_str(ENERGY_METER_NONE, "ENERGY_METER_NONE", 799556618u, 0, 17, &be_const_str_STATE_A);
be_define_const_str(Evse, "Evse", 1255518258u, 0, 4, &be_const_str_nil);
be_define_const_str(SERIAL_NONE, "SERIAL_NONE", 1267285320u, 0, 11, &be_const_str_exp);
be_define_const_str(SERIAL_RS485, "SERIAL_RS485", 1431239208u, 0, 12, &be_const_str_STATE_C);
be_define_const_str(SERIAL_UART, "SERIAL_UART", 3498043946u, 0, 11, &be_const_str_atan);
be_define_const_str(STATE_A, "STATE_A", 758070558u, 0, 7, &be_const_str_iter);
be_define_const_str(STATE_B, "STATE_B", 741292939u, 0, 7, &be_const_str_delay);
be_define_const_str(STATE_C, "STATE_C", 724515320u, 0, 7, &be_const_str_allocated);
be_define_const_str(STATE_D, "STATE_D", 841958653u, 0, 7, &be_const_str__process);
be_define_const_str(STATE_E, "STATE_E", 825181034u, 0, 7, &be_const_str_keys);
be_define_const_str(STATE_F, "STATE_F", 808403415u, 0, 7, &be_const_str_raise);
...
be_define_const_str(_process, "_process", 1973958659u, 0, 8, &be_const_str_bool);
...
be_define_const_str(add, "add", 993596020u, 0, 3, &be_const_str_current);
...
be_define_const_str(analog_read, "analog_read", 3234091506u, 0, 11, &be_const_str_cos);
...
be_define_const_str(bytes, "bytes", 1706151940u, 0, 5, &be_const_str_tr);
...
be_define_const_str(charging_current, "charging_current", 2980711800u, 0, 16, &be_const_str_clear);
be_define_const_str(charging_time, "charging_time", 2172372278u, 0, 13, &be_const_str_for);
be_define_const_str(class, "class", 2872970239u, 57, 5, &be_const_str_power);
...
be_define_const_str(cosh, "cosh", 4099687964u, 0, 4, &be_const_str_remove_driver);
be_define_const_str(count, "count", 967958004u, 0, 5, &be_const_str_seti);
be_define_const_str(current, "current", 3647323098u, 0, 7, &be_const_str_int);
...
be_define_const_str(delay, "delay", 1322381784u, 0, 5, &be_const_str_srand);
be_define_const_str(do, "do", 1646057492u, 65, 2, &be_const_str_state);
...
be_define_const_str(enabled, "enabled", 49525662u, 0, 7, &be_const_str_isnan);
be_define_const_str(end, "end", 1787721130u, 56, 3, &be_const_str_log10);
be_define_const_str(escape, "escape", 2652972038u, 0, 6, &be_const_str_tob64);
...
be_define_const_str(false, "false", 184981848u, 62, 5, &be_const_str_write);
...
be_define_const_str(input, "input", 4191711099u, 0, 5, &be_const_str_set_enabled);
...
be_define_const_str(iter, "iter", 3124256359u, 0, 4, &be_const_str_set);
...
be_define_const_str(members, "members", 937576464u, 0, 7, &be_const_str_set_charging_current);
...
be_define_const_str(read, "read", 3470762949u, 0, 4, &be_const_str_static);
...
static const bstring* const m_string_table[] = {
    ...
    (const bstring *)&be_const_str_STATE_B,
