...
be_define_const_str(_X28_X29, "()", 685372826u, 0, 2, &be_const_str_atan2);
be_define_const_str(_X2B, "+", 772578730u, 0, 1, &be_const_str_bytes);
be_define_const_str(_X2E_X2E, "..", 2748622605u, 0, 2, &be_const_str_Evse);
be_define_const_str(_X2Elen, ".len", 850842136u, 0, 4, &be_const_str___iterator__);
be_define_const_str(_X2Ep, ".p", 1171526419u, 0, 2, &be_const_str_isinstance);
be_define_const_str(_X2Esize, ".size", 1965188224u, 0, 5, &be_const_str_range);
be_define_const_str(_X3D_X3D, "==", 2431966415u, 0, 2, &be_const_str_STATE_B2);
be_define_const_str(ENERGY_METER_CUR, "ENERGY_METER_CUR", 1351509274u, 0, 16, &be_const_str_ENERGY_METER_NONE);
...
be_define_const_str(STATE_E, "STATE_E", 825181034u, 0, 7, &be_const_str_call);
be_define_const_str(STATE_F, "STATE_F", 808403415u, 0, 7, &be_const_str_bool);
be_define_const_str(__iterator__, "__iterator__", 3884039703u, 0, 12, &be_const_str_elif);
be_define_const_str(__lower__, "__lower__", 123855590u, 0, 9, &be_const_str_fromhex);
be_define_const_str(__upper__, "__upper__", 3612202883u, 0, 9, &be_const_str__buffer);
be_define_const_str(_buffer, "_buffer", 2044888568u, 0, 7, &be_const_str_print);
be_define_const_str(_change_buffer, "_change_buffer", 2101848693u, 0, 14, &be_const_str_rand);
be_define_const_str(_ctx, "_ctx", 3449684691u, 0, 4, NULL);
be_define_const_str(_process, "_process", 1973958659u, 0, 8, &be_const_str_cos);
be_define_const_str(abs, "abs", 709362235u, 0, 3, &be_const_str_deg);
be_define_const_str(acos, "acos", 1006755615u, 0, 4, &be_const_str_enabled);
be_define_const_str(add, "add", 993596020u, 0, 3, &be_const_str_add_driver);
be_define_const_str(add_driver, "add_driver", 1654458371u, 0, 10, NULL);
be_define_const_str(allocated, "allocated", 429986098u, 0, 9, &be_const_str_module);
be_define_const_str(analog_read, "analog_read", 3234091506u, 0, 11, &be_const_str_power);
...
be_define_const_str(atan, "atan", 108579519u, 0, 4, &be_const_str_charging_time);
...
be_define_const_str(bool, "bool", 3365180733u, 0, 4, &be_const_str_geti);
...
be_define_const_str(call, "call", 3018949801u, 0, 4, &be_const_str_setmember);
be_define_const_str(ceil, "ceil", 1659167240u, 0, 4, &be_const_str_import);
be_define_const_str(char, "char", 2823553821u, 0, 4, NULL);
be_define_const_str(charging_current, "charging_current", 2980711800u, 0, 16, &be_const_str_input);
be_define_const_str(charging_time, "charging_time", 2172372278u, 0, 13, &be_const_str_connect);
be_define_const_str(class, "class", 2872970239u, 57, 5, &be_const_str_imax);
...
be_define_const_str(clear, "clear", 1550717474u, 0, 5, &be_const_str_getfloat);
be_define_const_str(clock, "clock", 363073373u, 0, 5, &be_const_str_concat);
...
be_define_const_str(connect, "connect", 2866859257u, 0, 7, &be_const_str_do);
be_define_const_str(consumption, "consumption", 722593332u, 0, 11, &be_const_str_copy);
be_define_const_str(contains, "contains", 1825239352u, 0, 8, &be_const_str_except);
be_define_const_str(continue, "continue", 2977070660u, 59, 8, &be_const_str_item);
be_define_const_str(copy, "copy", 3848464964u, 0, 4, &be_const_str_set_available);
be_define_const_str(cos, "cos", 4220379804u, 0, 3, &be_const_str_resize);
be_define_const_str(cosh, "cosh", 4099687964u, 0, 4, &be_const_str_set);
...
be_define_const_str(deinit, "deinit", 2345559592u, 0, 6, &be_const_str_floor);
...
be_define_const_str(elif, "elif", 3232090307u, 51, 4, &be_const_str_read);
be_define_const_str(else, "else", 3183434736u, 52, 4, &be_const_str_fromb64);
be_define_const_str(enabled, "enabled", 49525662u, 0, 7, NULL);
be_define_const_str(end, "end", 1787721130u, 56, 3, &be_const_str_fromptr);
be_define_const_str(escape, "escape", 2652972038u, 0, 6, &be_const_str_set_enabled);
be_define_const_str(except, "except", 950914032u, 69, 6, &be_const_str_time);
be_define_const_str(exp, "exp", 1923516200u, 0, 3, &be_const_str_log);
be_define_const_str(false, "false", 184981848u, 62, 5, &be_const_str_if);
be_define_const_str(find, "find", 3186656602u, 0, 4, &be_const_str_for);
be_define_const_str(floor, "floor", 3102149661u, 0, 5, NULL);
be_define_const_str(for, "for", 2901640080u, 54, 3, &be_const_str_remove);
...
be_define_const_str(getfloat, "getfloat", 2820979603u, 0, 8, &be_const_str_hex);
...
be_define_const_str(input, "input", 4191711099u, 0, 5, &be_const_str_pop);
...
be_define_const_str(isinstance, "isinstance", 3669352738u, 0, 10, &be_const_str_write);
be_define_const_str(ismapped, "ismapped", 2725004770u, 0, 8, &be_const_str_reverse);
be_define_const_str(ismethod, "ismethod", 3513438880u, 0, 8, &be_const_str_static);
...
be_define_const_str(keys, "keys", 4182378701u, 0, 4, &be_const_str_pi);
...
be_define_const_str(load, "load", 3859241449u, 0, 4, &be_const_str_tr);
be_define_const_str(log, "log", 1062293841u, 0, 3, &be_const_str_members);
...
be_define_const_str(map, "map", 3751997361u, 0, 3, &be_const_str_tanh);
...
be_define_const_str(rand, "rand", 2711325910u, 0, 4, &be_const_str_srand);
be_define_const_str(range, "range", 4208725202u, 0, 5, NULL);
be_define_const_str(read, "read", 3470762949u, 0, 4, &be_const_str_return);
be_define_const_str(real, "real", 3604983901u, 0, 4, NULL);
be_define_const_str(remove, "remove", 3683784189u, 0, 6, &be_const_str_set_charging_current);
be_define_const_str(remove_driver, "remove_driver", 1030243768u, 0, 13, &be_const_str_tolower);
be_define_const_str(replace, "replace", 2704835779u, 0, 7, NULL);
be_define_const_str(resize, "resize", 3514612129u, 0, 6, NULL);
be_define_const_str(return, "return", 2246981567u, 60, 6, &be_const_str_tostring);
be_define_const_str(reverse, "reverse", 558918661u, 0, 7, &be_const_str_tohex);
be_define_const_str(session_time, "session_time", 3430506065u, 0, 12, &be_const_str_solidified);
be_define_const_str(set, "set", 3324446467u, 0, 3, NULL);
be_define_const_str(set_available, "set_available", 2820840055u, 0, 13, &be_const_str_super);
...
be_define_const_str(state, "state", 2016490230u, 0, 5, &be_const_str_type);
...
be_define_const_str(tanh, "tanh", 153638352u, 0, 4, &be_const_str_true);
...
be_define_const_str(toupper, "toupper", 3691983576u, 0, 7, &be_const_str_voltage);
be_define_const_str(tr, "tr", 1195724803u, 0, 2, &be_const_str_try);
